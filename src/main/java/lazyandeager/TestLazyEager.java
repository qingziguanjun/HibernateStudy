...
public class TestLazyEager {
	public static void main(String[] args) {
	  ...
	  // insertData(sessionFactory);
	    ...
	    Employee e = em.getReference(Employee.class, 25);
	    Employee e2 = em.find(Employee.class, 25);
	    int  s = e.getId();
	...
	private static void insertData(SessionFactory sessionFactory) {
		Session em = sessionFactory.openSession();// 从会话工厂获取一个session
		  //  EntityManager em = sessionFactory.createEntityManager();
		    
		    Transaction t = em.beginTransaction();
		    //Transaction t =  (Transaction) em.getTransaction();
